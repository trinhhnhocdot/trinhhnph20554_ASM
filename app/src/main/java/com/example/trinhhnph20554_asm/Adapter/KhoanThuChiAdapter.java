...
public class KhoanThuChiAdapter extends BaseAdapter {
    ...
    public KhoanThuChiAdapter(ArrayList<KhoanThuChi> list, Context context, KhoanThuChiDAO thuChiDAO,ArrayList<HashMap<String,Object>> listSpiner) {
        this.list = list;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view==null){
            view = inflater.inflate(R.layout.item_khoanthu,parent,false);
